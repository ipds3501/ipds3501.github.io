administrasi_json = [
			{
			  	...
			  	"ikon": "https://sirup.lkpp.go.id/sirup/public/images/web/logo-header-latihan.png",
			  	"url": "https://sirup.lkpp.go.id/"
			},
			{
				"nama": "SAKTI",
				"desc": "Sistem Aplikasi Keuangan Tingkat Instansi.",
				"ikon": "https://sakti.kemenkeu.go.id/assets/img/logo.png",
			  	"url": "https://sakti.kemenkeu.go.id/"
			},
			{
				"nama": "E-Monev",
				"desc": "Aplikasi pelaporan E-Monev Bappenas.",
				"ikon": "https://e-monev.bappenas.go.id/fe/assets/images/logo2_2.png",
			...
			},
			{
				...
				"ikon": "https://smart.kemenkeu.go.id/assets/images/logomonev.png",
			  	"url": "https://smart.kemenkeu.go.id/"
			},
			{
				"nama": "MonSakti",
				"desc": "Sistem Monitoring Keuangan Tingkat Instansi",
				"ikon": "https://i.imgur.com/lri52YT.png",
			  	"url": "https://monsakti.kemenkeu.go.id/"
			},
			{
				"nama": "SiMonev BPS",
				"desc": "Sistem Informasi Monitoring dan Evaluasi BPS",
				"ikon": "https://monev.bps.go.id/monevnew/login_v2/images/SIMonev.png",
			  	"url": "https://monev.bps.go.id/"
			},
			{
				"nama": "CMS BRI",
				"desc": "Sistem Pengelolaan Keuangan BRI",
				"ikon": "https://ibank.bri.co.id/cms/images/leftheadertabel.png",
